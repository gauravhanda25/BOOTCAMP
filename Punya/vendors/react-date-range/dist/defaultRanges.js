...
var defineds = {
  ...
  startOfYear:  (0, _startOfYear2.default)(new Date()),
  endOfYear:  (0, _endOfYear2.default)(new Date()),
  startOfLastYear: (0, _startOfYear2.default)((0, _addYears2.default)(new Date(), -1)),
  endOfLastYear: (0, _endOfYear2.default)((0, _addYears2.default)(new Date(), -1)),
};
