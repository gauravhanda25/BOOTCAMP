...
class HipaaTermsOfUse extends Component {
  constructor(props) {
    super(props);
        ...
        <div className="wide-popup">
          <div className="wide-popup-wrapper">
            <div className="popup-btns popup-three-btns">
              ...
              <div className="content-hipaa-terms-of-use"></div>
          </div>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(HipaaTermsOfUse);
